...
export const authFeature = Feature('Authentication', {
  [Scenario('setup')]: [
    ...
    `Concat Resource Server and ${v.Token_Path} as Authorization Server`,
    `Concat Resource Server and ${v.Profile_Path} as Profile API`,
    `Concat Resource Server and ${v.Resources_Path} as Resources API`,
    `Concat Resource Server and ${v.Resource_Path} as Resource API`,
    `Concat Resource Server and ${v.Resource_Delete_Route} as Resource Delete API`,
    `Concat Resource Server and "/logout?post_logout_redirect_uri=http://localhost:8123/static/loggedOut" as ${v.Logout}`,
    `Set ${v.OK} to 200`,
