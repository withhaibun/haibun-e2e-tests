...
var util_1 = require("@haibun/core/build/lib/util");
var defs_1 = require("@haibun/web-server-express/build/defs");
var TALLY = 'tally';
                ...
                action: function (_a) {
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    webserver = (0, util_1.getFromRuntime)(this.world.runtime, defs_1.WEBSERVER);
                                    return [4 /*yield*/, webserver.addRoute('get', loc, this.route)];
                                case 1:
                                    _b.sent();
                                    return [2 /*return*/, (0, util_1.actionOK)()];
                            }
                        });
                    });
                },
