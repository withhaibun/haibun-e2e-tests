...
declare class TestServer extends AStepper {
    ...
    addRoute: (route: TRequestHandler, method?: "get" | "post" | "delete") => (args: TStepArgs, vstep: TFeatureStep) => Promise<import("@haibun/core/lib/defs.js").TNotOKActionResult | import("@haibun/core/lib/defs.js").TOKActionResult>;
